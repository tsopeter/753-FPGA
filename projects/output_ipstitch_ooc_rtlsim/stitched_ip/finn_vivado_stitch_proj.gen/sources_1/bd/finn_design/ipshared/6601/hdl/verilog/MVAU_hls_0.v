...
(* CORE_GENERATION_INFO="MVAU_hls_0_MVAU_hls_0,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7s25-csga225-1,HLS_INPUT_CLOCK=12.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.101000,HLS_SYN_LAT=315009,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=532,HLS_SYN_LUT=980,HLS_VERSION=2022_2}" *)
