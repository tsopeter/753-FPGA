...
module myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [2:0] w19_address0;
wire  signed [4:0] w19_q0;
reg   [0:0] do_init_reg_103;
reg   [2:0] w_index3_reg_119;
reg   [5:0] data_0_val8_rewind_reg_134;
reg   [5:0] data_1_val9_rewind_reg_148;
reg   [5:0] data_2_val10_rewind_reg_162;
reg   [5:0] data_3_val11_rewind_reg_176;
reg   [5:0] data_4_val12_rewind_reg_190;
reg  signed [12:0] res_04_reg_204;
wire   [2:0] w_index_fu_283_p2;
reg   [2:0] w_index_reg_381;
reg   [0:0] icmp_ln46_reg_386;
wire   [12:0] trunc_ln46_fu_335_p1;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0_subdone;
reg   [0:0] ap_phi_mux_do_init_phi_fu_107_p6;
wire    ap_block_pp0_stage0;
reg   [2:0] ap_phi_mux_w_index3_phi_fu_123_p6;
reg   [5:0] ap_phi_mux_data_0_val8_phi_phi_fu_222_p4;
reg   [5:0] ap_phi_mux_data_1_val9_phi_phi_fu_234_p4;
reg   [5:0] ap_phi_mux_data_2_val10_phi_phi_fu_246_p4;
reg   [5:0] ap_phi_mux_data_3_val11_phi_phi_fu_258_p4;
reg   [5:0] ap_phi_mux_data_4_val12_phi_phi_fu_270_p4;
wire   [5:0] ap_phi_reg_pp0_iter0_data_0_val8_phi_reg_218;
reg   [5:0] ap_phi_reg_pp0_iter1_data_0_val8_phi_reg_218;
wire   [5:0] ap_phi_reg_pp0_iter0_data_1_val9_phi_reg_230;
reg   [5:0] ap_phi_reg_pp0_iter1_data_1_val9_phi_reg_230;
wire   [5:0] ap_phi_reg_pp0_iter0_data_2_val10_phi_reg_242;
reg   [5:0] ap_phi_reg_pp0_iter1_data_2_val10_phi_reg_242;
wire   [5:0] ap_phi_reg_pp0_iter0_data_3_val11_phi_reg_254;
reg   [5:0] ap_phi_reg_pp0_iter1_data_3_val11_phi_reg_254;
wire   [5:0] ap_phi_reg_pp0_iter0_data_4_val12_phi_reg_266;
reg   [5:0] ap_phi_reg_pp0_iter1_data_4_val12_phi_reg_266;
wire   [63:0] zext_ln46_fu_278_p1;
reg    w19_ce0_local;
wire   [5:0] a_fu_299_p11;
wire   [5:0] a_fu_299_p13;
wire  signed [13:0] grp_fu_341_p3;
wire   [5:0] grp_fu_341_p0;
...
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [10:0] grp_fu_341_p00;
reg    ap_condition_115;
reg    ap_condition_37;
wire   [2:0] a_fu_299_p1;
wire   [2:0] a_fu_299_p3;
wire   [2:0] a_fu_299_p5;
wire   [2:0] a_fu_299_p7;
wire  signed [2:0] a_fu_299_p9;
wire    ap_ce_reg;
...
myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s_w19_ROM_NPVhK #(
    .DataWidth( 5 ),
    .AddressRange( 5 ),
    .AddressWidth( 3 ))
w19_U(
...
myproject_mac_muladd_6ns_5s_13s_14_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 5 ),
    .din2_WIDTH( 13 ),
    .dout_WIDTH( 14 ))
mac_muladd_6ns_5s_13s_14_1_1_U679(
    .din0(grp_fu_341_p0),
    .din1(w19_q0),
    .din2(res_04_reg_204),
    .dout(grp_fu_341_p3)
...
assign ap_phi_reg_pp0_iter0_data_0_val8_phi_reg_218 = 'bx;

assign ap_phi_reg_pp0_iter0_data_1_val9_phi_reg_230 = 'bx;

assign ap_phi_reg_pp0_iter0_data_2_val10_phi_reg_242 = 'bx;

assign ap_phi_reg_pp0_iter0_data_3_val11_phi_reg_254 = 'bx;

assign ap_phi_reg_pp0_iter0_data_4_val12_phi_reg_266 = 'bx;

assign grp_fu_341_p0 = grp_fu_341_p00;

assign grp_fu_341_p00 = a_fu_299_p13;

assign icmp_ln46_fu_289_p2 = ((ap_phi_mux_w_index3_phi_fu_123_p6 == 3'd4) ? 1'b1 : 1'b0);

assign trunc_ln46_fu_335_p1 = grp_fu_341_p3[12:0];

assign w19_address0 = zext_ln46_fu_278_p1;
...
endmodule //myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s
