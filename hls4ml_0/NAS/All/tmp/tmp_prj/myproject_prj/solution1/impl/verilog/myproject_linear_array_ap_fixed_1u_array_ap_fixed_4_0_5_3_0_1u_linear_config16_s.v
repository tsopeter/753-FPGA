...
module myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config16_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [7:0] layer16_out_TDATA_int_regslice;
...
always @ (*) begin
    ap_block_state1 = ((layer16_out_TREADY_int_regslice == 1'b0) | (ap_start == 1'b0) | (layer15_out_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state2 = ((layer16_out_TREADY_int_regslice == 1'b0) | (regslice_both_layer16_out_U_apdone_blk == 1'b1));
end

assign layer16_out_TDATA_int_regslice = tmp_fu_43_p4;

assign layer16_out_TVALID = regslice_both_layer16_out_U_vld_out;

assign tmp_fu_43_p4 = {{layer15_out_dout[9:6]}};

endmodule //myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config16_s
