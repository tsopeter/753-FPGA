...
entity myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config17_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config17_s is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, layer16_out_empty_n, layer17_out_TREADY_int_regslice)
    begin
                ap_block_state1 <= ((layer17_out_TREADY_int_regslice = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (layer16_out_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state2_assign_proc : process(regslice_both_layer17_out_U_apdone_blk, layer17_out_TREADY_int_regslice)
    begin
                ap_block_state2 <= ((layer17_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer17_out_U_apdone_blk = ap_const_logic_1));
    end process;
    ...
    layer17_out_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, ap_CS_fsm_state2, layer17_out_TREADY_int_regslice)
    begin
    ...
    layer17_out_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_43_p4),8));
    layer17_out_TVALID <= regslice_both_layer17_out_U_vld_out;

    layer17_out_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_fu_43_p4 <= layer16_out_dout(9 downto 6);
end behav;
