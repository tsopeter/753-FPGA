...
entity myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config18_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    layer18_out_TDATA : OUT STD_LOGIC_VECTOR (7 downto 0);
    layer18_out_TVALID : OUT STD_LOGIC;
    layer18_out_TREADY : IN STD_LOGIC );
end;


architecture behav of myproject_linear_array_ap_fixed_1u_array_ap_fixed_4_0_5_3_0_1u_linear_config18_s is 
...
attribute shreg_extract : string;
    ...
    signal layer18_out_TDATA_int_regslice : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, layer17_out_empty_n, layer18_out_TREADY_int_regslice)
    begin
                ap_block_state1 <= ((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (layer17_out_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state2_assign_proc : process(regslice_both_layer18_out_U_apdone_blk, layer18_out_TREADY_int_regslice)
    begin
                ap_block_state2 <= ((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer18_out_U_apdone_blk = ap_const_logic_1));
    end process;
    ...
    layer18_out_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, ap_CS_fsm_state2, layer18_out_TREADY_int_regslice)
    begin
    ...
    layer18_out_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_43_p4),8));
    layer18_out_TVALID <= regslice_both_layer18_out_U_vld_out;

    layer18_out_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_fu_43_p4 <= layer17_out_dout(9 downto 6);
end behav;
