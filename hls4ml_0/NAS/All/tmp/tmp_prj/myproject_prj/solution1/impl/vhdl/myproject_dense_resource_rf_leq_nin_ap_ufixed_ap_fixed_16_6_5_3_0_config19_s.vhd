...
entity myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s is 
...
attribute shreg_extract : string;
    ...
    signal w19_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal w19_q0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal w19_ce0_local : STD_LOGIC;
    ...
    signal grp_fu_341_p00 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component myproject_mac_muladd_6ns_5s_13s_14_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s_w19_ROM_NPVhK IS
    generic (
        DataWidth : INTEGER;
...
begin
    w19_U : component myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_16_6_5_3_0_config19_s_w19_ROM_NPVhK
    generic map (
        DataWidth => 5,
        AddressRange => 5,
        AddressWidth => 3)
    ...
    sparsemux_11_3_6_1_1_U678 : component myproject_sparsemux_11_3_6_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000",
    ...
    mac_muladd_6ns_5s_13s_14_1_1_U679 : component myproject_mac_muladd_6ns_5s_13s_14_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 6,
    ...
    grp_fu_341_p0 <= grp_fu_341_p00(6 - 1 downto 0);
    grp_fu_341_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(a_fu_299_p13),11));
    ...
    w19_address0 <= zext_ln46_fu_278_p1(3 - 1 downto 0);

    w19_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            w19_ce0_local <= ap_const_logic_1;
        else 
            w19_ce0_local <= ap_const_logic_0;
        end if; 
    end process;
