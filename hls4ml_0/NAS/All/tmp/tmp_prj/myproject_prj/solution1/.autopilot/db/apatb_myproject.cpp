...
#define AUTOTB_TVOUT_layer13_out "../tv/cdatafile/c.myproject.autotvout_layer13_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer13_out "../tv/stream_size/stream_size_out_layer13_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer13_out "../tv/stream_size/stream_egress_status_layer13_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer13_out "../tv/rtldatafile/rtl.myproject.autotvout_layer13_out.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_1, void* __xlx_apatb_param_layer13_out)
{
  ...
  static hls::sim::Stream<hls::sim::Byte<1>> port1 {
    ...
    .name = "layer13_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer13_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer13_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer13_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer13_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_layer13_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_1, __xlx_apatb_param_layer13_out);
    port1.buffer();
