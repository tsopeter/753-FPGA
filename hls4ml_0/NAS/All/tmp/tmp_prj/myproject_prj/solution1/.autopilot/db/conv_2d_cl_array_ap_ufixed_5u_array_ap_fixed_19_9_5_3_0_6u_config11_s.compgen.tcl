...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer11_out_din { O 114 vector } layer11_out_full_n { I 1 bit } layer11_out_write { O 1 bit } layer11_out_num_data_valid { I 5 vector } layer11_out_fifo_cap { I 5 vector } } \
} "
}
