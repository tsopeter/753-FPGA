...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer15_out_din { O 220 vector } layer15_out_full_n { I 1 bit } layer15_out_write { O 1 bit } layer15_out_num_data_valid { I 2 vector } layer15_out_fifo_cap { I 2 vector } } \
} "
}
