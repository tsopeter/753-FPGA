...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer12_out_din { O 20 vector } layer12_out_full_n { I 1 bit } layer12_out_write { O 1 bit } layer12_out_num_data_valid { I 2 vector } layer12_out_fifo_cap { I 2 vector } } \
} "
}
