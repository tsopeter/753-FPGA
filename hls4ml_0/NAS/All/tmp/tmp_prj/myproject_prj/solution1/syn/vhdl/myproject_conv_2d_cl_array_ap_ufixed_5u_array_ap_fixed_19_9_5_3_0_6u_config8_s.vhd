    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                trunc_ln57_1_reg_402 <= layer7_out_dout(11 downto 6);
                trunc_ln57_2_reg_407 <= layer7_out_dout(17 downto 12);
                trunc_ln57_3_reg_412 <= layer7_out_dout(23 downto 18);
                trunc_ln57_4_reg_417 <= layer7_out_dout(29 downto 24);
