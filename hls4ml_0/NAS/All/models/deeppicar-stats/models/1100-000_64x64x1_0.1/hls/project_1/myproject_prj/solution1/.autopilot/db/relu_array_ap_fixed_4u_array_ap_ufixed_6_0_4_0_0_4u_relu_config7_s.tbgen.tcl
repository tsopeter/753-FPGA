set moduleName relu_array_ap_fixed_4u_array_ap_ufixed_6_0_4_0_0_4u_relu_config7_s
set isTopModule 0
...
set cdfgNum 21
set C_modelName {relu<array<ap_fixed,4u>,array<ap_ufixed<6,0,4,0,0>,4u>,relu_config7>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer5_out int 76 regular {fifo 0 volatile }  }
	{ layer7_out int 24 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 76, "direction" : "READONLY"} , 
 	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer5_out_dout sc_in sc_lv 76 signal 0 } 
	...
	{ layer7_out_din sc_out sc_lv 24 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer5_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":76, "type": "signal", "bundle":{"name": "layer5_out", "role": "dout" }} , 
 	...
 	{ "name": "layer7_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "layer7_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer5_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "169", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer5_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer7_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "169", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_in 0 76 }  { layer5_out_empty_n fifo_status 0 1 }  { layer5_out_read fifo_port_we 1 1 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer5_out_fifo_cap fifo_update 0 9 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_data_in 1 24 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_port_we 1 1 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer7_out_fifo_cap fifo_update 0 9 } } }
}
