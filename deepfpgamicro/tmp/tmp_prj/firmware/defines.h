...
#define OUT_WIDTH_6 13
#define N_FILT_6 4
#define OUT_HEIGHT_9 11
#define OUT_WIDTH_9 11
#define N_FILT_9 6
#define OUT_HEIGHT_9 11
#define OUT_WIDTH_9 11
#define N_FILT_9 6
#define OUT_HEIGHT_12 9
#define OUT_WIDTH_12 9
#define N_FILT_12 6
#define OUT_HEIGHT_12 9
#define OUT_WIDTH_12 9
#define N_FILT_12 6
#define N_SIZE_0_15 486
#define N_LAYER_16 1
...
typedef ap_fixed<19,9> q_conv2d_24_accum_t;
typedef nnet::array<ap_fixed<19,9>, 4*1> q_conv2d_24_result_t;
...
typedef ap_fixed<19,9> q_conv2d_26_accum_t;
typedef nnet::array<ap_fixed<19,9>, 6*1> q_conv2d_26_result_t;
typedef ap_fixed<6,2> weight9_t;
typedef ap_fixed<6,2> bias9_t;
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT,0>, 6*1> layer11_t;
typedef ap_fixed<18,8> q_activation_21_table_t;
typedef ap_fixed<19,9> q_conv2d_27_accum_t;
typedef nnet::array<ap_fixed<19,9>, 6*1> q_conv2d_27_result_t;
...
typedef ap_fixed<22,12> output_1_accum_t;
