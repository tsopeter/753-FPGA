...
#
# Script generated by Vivado on Sun May 04 17:25:58 -0500 2025
...
#
# Usage        : accel.sh
#                accel.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                accel.sh [-reset_run]
#                accel.sh [-reset_log]
#                accel.sh [-help]
#
...
#                script (type 'accel.sh -help' for more information).
#
...
# script info
echo -e "accel.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./accel.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../model_testbench.gen/sources_1/bd/accel/ipshared/e9b6/hdl/verilog" +incdir+"../../../../model_testbench.gen/sources_1/bd/accel/ipshared/e9b6/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.accel xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.accel -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log accel_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: accel.sh [-reset_log]\n\
Usage: accel.sh [-keep_index]\n\
