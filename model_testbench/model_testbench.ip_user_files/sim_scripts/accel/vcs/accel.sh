...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../model_testbench.gen/sources_1/bd/accel/ipshared/e9b6/hdl/verilog" +incdir+"../../../../model_testbench.gen/sources_1/bd/accel/ipshared/e9b6/hdl/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key accel_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc accel_simv.daidir vcs_lib c.obj)
