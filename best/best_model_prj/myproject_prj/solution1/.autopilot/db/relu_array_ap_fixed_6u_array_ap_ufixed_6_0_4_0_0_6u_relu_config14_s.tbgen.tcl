set moduleName relu_array_ap_fixed_6u_array_ap_ufixed_6_0_4_0_0_6u_relu_config14_s
set isTopModule 0
...
set cdfgNum 26
set C_modelName {relu<array<ap_fixed,6u>,array<ap_ufixed<6,0,4,0,0>,6u>,relu_config14>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer12_out int 114 regular {fifo 0 volatile }  }
	{ layer14_out int 36 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 114, "direction" : "READONLY"} , 
 	{ "Name" : "layer14_out", "interface" : "fifo", "bitwidth" : 36, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer12_out_dout sc_in sc_lv 114 signal 0 } 
	...
	{ layer14_out_din sc_out sc_lv 36 signal 1 } 
	{ layer14_out_full_n sc_in sc_logic 1 signal 1 } 
	{ layer14_out_write sc_out sc_logic 1 signal 1 } 
	{ layer14_out_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ layer14_out_fifo_cap sc_in sc_lv 5 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":114, "type": "signal", "bundle":{"name": "layer12_out", "role": "dout" }} , 
 	...
 	{ "name": "layer14_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "layer14_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer12_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer12_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer14_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer12_out { ap_fifo {  { layer12_out_dout fifo_data_in 0 114 }  { layer12_out_empty_n fifo_status 0 1 }  { layer12_out_read fifo_port_we 1 1 }  { layer12_out_num_data_valid fifo_status_num_data_valid 0 5 }  { layer12_out_fifo_cap fifo_update 0 5 } } }
	layer14_out { ap_fifo {  { layer14_out_din fifo_data_in 1 36 }  { layer14_out_full_n fifo_status 0 1 }  { layer14_out_write fifo_port_we 1 1 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 5 }  { layer14_out_fifo_cap fifo_update 0 5 } } }
}
