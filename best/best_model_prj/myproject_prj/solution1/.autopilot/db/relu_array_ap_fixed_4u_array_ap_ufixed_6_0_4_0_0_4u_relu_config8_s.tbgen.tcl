...
set C_modelArgList {
	{ layer6_out int 76 regular {fifo 0 volatile }  }
	{ layer8_out int 24 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 76, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer6_out_dout sc_in sc_lv 76 signal 0 } 
	...
	{ layer8_out_din sc_out sc_lv 24 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":76, "type": "signal", "bundle":{"name": "layer6_out", "role": "dout" }} , 
 	...
 	{ "name": "layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "layer8_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 76 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer6_out_fifo_cap fifo_update 0 9 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_in 1 24 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_port_we 1 1 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer8_out_fifo_cap fifo_update 0 9 } } }
}
