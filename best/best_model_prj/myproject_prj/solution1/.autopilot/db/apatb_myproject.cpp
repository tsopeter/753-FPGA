...
#define AUTOTB_TVOUT_layer16_out "../tv/cdatafile/c.myproject.autotvout_layer16_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer16_out "../tv/stream_size/stream_size_out_layer16_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer16_out "../tv/stream_size/stream_egress_status_layer16_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer16_out "../tv/rtldatafile/rtl.myproject.autotvout_layer16_out.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_1, void* __xlx_apatb_param_layer16_out)
{
...
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer16_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer16_out),
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_1, __xlx_apatb_param_layer16_out);
    port1.buffer();
